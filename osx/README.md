this requires py2app and OSX, essentially you just run the provision.sh script to set up the payload and the stager.py script, then create the application with python setup.py py2app
